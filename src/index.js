...
var base = Rebase.createClass({
  apiKey: "AIzaSyDOXoxFAqvq-2RppQl9txOfjNmZeW1z8dw",   // replace with your Firebase application's API key
  databaseURL: "https://final-94f8b.firebaseio.com", // replace with your Firebase application's database URL
})
      ...
      <div className="sort row">
        <div className="col-sm-12">
          <ul className="nav nav-pills">
            <li className = "latest"><a href="#" onClick={() => this.viewChanged('latest')}>Latest Releases</a></li>
            <li className = "alpha"><a href="#" onClick={() => this.viewChanged('alpha')}>A-Z</a></li>
            <li className = "map"><a href="#" onClick={() => this.viewChanged('map')}>Where to Watch</a></li>
